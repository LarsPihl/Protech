...
<button id = "borderButton" class = "marginLeft readMoreFirst">Läs mer om oss</button>
<br>
...
<p class = "marginLeft imgText"></p>
<div class = "slideButtons">
  <button class = "slide" onclick = "swipeImage(-1, 1, circleArea2, images2)"><</button>
<button class = "slide" onclick = "swipeImage(1, 1, circleArea2, images2)">></button>
</div>
<button class = "marginLeft readMore" id = "borderButton">Läs mer</button>
</div>
...
<p class = "marginLeft imgText"></p>
<div class = "slideButtons">
  <button class = "slide" onclick = "swipeImage(-1, 2, circleArea3, images3)"><</button>
<button class = "slide" onclick = "swipeImage(1, 2, circleArea3, images3)">></button>
</div>
<button class = "marginLeft readMore" id = "borderButton">Läs mer</button>
</div>
